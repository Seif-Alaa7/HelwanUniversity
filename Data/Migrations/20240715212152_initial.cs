    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HighBoards", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StudentsAllowed = table.Column<int>(type: "int", nullable: false),
                    summerStatus = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Faculties_HighBoards_DeanId",
                        column: x => x.DeanId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PaymentFees = table.Column<bool>(type: "bit", nullable: false),
                    PaymentFeesDate = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GPASemester = table.Column<decimal>(type: "decimal(18,3)", nullable: false),
                    GPATotal = table.Column<decimal>(type: "decimal(18,3)", nullable: false),
                    CreditHours = table.Column<int>(type: "int", nullable: false),
                    RecordedHours = table.Column<int>(type: "int", nullable: false),
                    TotalHours = table.Column<int>(type: "int", nullable: false),
                    SemesterPoints = table.Column<decimal>(type: "decimal(18,3)", nullable: false),
                    TotalPoints = table.Column<decimal>(type: "decimal(18,3)", nullable: false),
                    Level = table.Column<int>(type: "int", nullable: false),
                    Semester = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DegreePoints = table.Column<decimal>(type: "decimal(18,3)", nullable: false)
                },
                constraints: table =>
                {
